export default {
  app: {
    ...
    calculation: {
      ...
      largestSegment: 'Bloque más grande',
      x: 'Cromosoma X',
      age: 'Diferencia de edad',
      generation: 'Generación declarada',
      neutral: 'neutral (sin datos o dentro del rango típico)',
      boost: 'refuerza esta hipótesis',
